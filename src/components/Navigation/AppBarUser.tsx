...
import {  IconButton, Box, Divider, List, Dialog, ListItemText, ListItemButton, ListItem, CssBaseline, MuiDrawer} from '@mui/material';
...
export default function AppBarUser() {
    ...
    const items = ['New', 'Get Infinity', 'Dashboard', 'Accounts', 'Transactions', 'Rewards', 'More Options', 'Settings', 'Help center'];
